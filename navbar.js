...
class NavbarManager {
    ...
    setupEventListeners() {
        ...
        document.onclick = (e) => {
            if (!e.target.closest('.icon-btn') && !e.target.closest('.dropdown-menu') && !e.target.closest('.user-profile') && !e.target.closest('.mobile-menu-toggle') && !e.target.closest('.mobile-nav-menu')) {
                document.querySelectorAll('.dropdown-menu, .mobile-nav-menu').forEach(d => d.classList.remove('show'));
            }
        };
    }
    ...
    toggleDropdown(dropdownId) {
        ...
        document.querySelectorAll('.dropdown-menu, .mobile-nav-menu').forEach(d => {
